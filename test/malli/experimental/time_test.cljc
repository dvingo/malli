...
(t/deftest basic-types
  ...
  (t/testing "Period"
    (t/is (m/validate :time/period (. Period ofYears 10) {:registry r}))
...
(t/deftest min-max
  ...
  (t/testing "Period"
    ...
    (t/is (-> [:time/period {:min (. Period of 8 10 11) :max (. Period of 9 10 12)}]
            (m/validate (. Period ofYears 9) {:registry r})))
    (t/is (-> [:time/period {:min (. Period of 8 10 11) :max (. Period of 9 10 12)}]
            (m/validate (. Period of 9 10 10) {:registry r})))
